<template>
  ...
  >
    <form style="width: 500px" @submit="onSubmit">
      <fieldset>
        <legend class="text-center text-danger">Profili Düzenle</legend>
        ...
        <div class="form-group">
          ...
          <small
            v-if="
              $v.user.text.minLength &&
              $v.user.text.maxLength &&
              $v.user.text.required
            "
                ...
                <div class="card-footer">
                 ...
                 <ul class="list-inline">
                  <li class="list-inline-item">
                    <a
                      class="social-icon text-xs-center p-2"
                      target="_blank"
